...
<template>
    <n-scrollbar>
        ...
        <n-tabs type="line" style="padding-left: 4%; width: 92%; padding-top: 5px" animated>
            <n-tab-pane name="所参加的比赛" tab="所参加的比赛">
                <n-grid x-gap="5" y-gap="5" :cols="cardN"
                    ...
                    <n-gi v-for="list in matchList" :key="list.key">
                        <n-card :title="list.name">
                            ...
                            <template #action>
                                <n-button style="margin: 5px" :disabled="list.type == 1" type="primary">修改内容</n-button>

                                <n-button style="margin: 5px" :disabled="list.type == 1" type="error">退出比赛</n-button>
                            </template>
                        </n-card>
                    </n-gi>
                </n-grid>
                ...
                <n-grid x-gap="5" y-gap="5" :cols="cardN"
                    ...
                    <n-gi v-for="list in matchList" :key="list.key">
                        <n-card :title="list.name" v-if="list.type === 0">
                            ...
                            <template #action>
                                <n-button style="margin: 5px" type="primary">修改内容</n-button>

                                <n-button style="margin: 5px" type="error">退出比赛</n-button>
                            </template>
                        </n-card>
                    </n-gi>
                </n-grid>
                ...
                <n-grid x-gap="5" y-gap="5" :cols="cardN"
                    ...
                    <n-gi v-for="list in matchList" :key="list.key">
                        <n-card :title="list.name" v-if="list.type === 1">
                            ...
                            <template #action>
                                <n-button style="margin: 5px" :disabled="true" type="primary">修改内容</n-button>

                                <n-button style="margin: 5px" :disabled="true" type="error">退出比赛</n-button>
                            </template>
                        </n-card>
                    </n-gi>
                </n-grid>
